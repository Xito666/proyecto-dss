...
{
        System.Collections.Generic.IList<InfoCosteProgramaGenNHibernate.EN.InfoCoste.ProductoEN> result;
        try
        {
                SessionInitializeTransaction ();
                //String sql = @"FROM ProductoEN self where FROM ProductoEN p where p.Nombre = :nombreFiltro";
                //IQuery query = session.CreateQuery(sql);
                IQuery query = (IQuery)session.GetNamedQuery ("ProductoENleerPorNombreHQL");
                query.SetParameter ("nombreFiltro", nombreFiltro);

                result = query.List<InfoCosteProgramaGenNHibernate.EN.InfoCoste.ProductoEN>();
                SessionCommit ();
        }
...
public System.Collections.Generic.IList<InfoCosteProgramaGenNHibernate.EN.InfoCoste.ProductoEN> LeerPorFamilia (string familiaFiltro)
{
        ...
        {
                SessionInitializeTransaction ();
                //String sql = @"FROM ProductoEN self where FROM ProductoEN p where p.Familia = :familiaFiltro";
                //IQuery query = session.CreateQuery(sql);
                IQuery query = (IQuery)session.GetNamedQuery ("ProductoENleerPorFamiliaHQL");
                query.SetParameter ("familiaFiltro", familiaFiltro);
...
public void SetDescription (ProductoEN producto)
{
        try
        {
                SessionInitializeTransaction ();
